...
class MainWindow(QMainWindow):
	...
	def setupUi(self):
		self.offline = QUiLoader().load('220216_Offline_edited.ui')
		
		self.setCentralWidget(self.offline)
...
## ---- funtions
	...
	def load_video(self):
		self.open_video_path = str(QFileDialog.getOpenFileName(self, "select media file",'./','Video (*.mp4 *.wma *.avi)')[0]) ## 형식*, Qurl 기본폴더
