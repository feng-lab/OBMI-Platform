...
class Table(QWidget):
    ...
    def __init__(self, type, parent=None):
        ...
        if type == 0:  # type0 for offline tab, type1 for online tab
            ...
            self.spinboxX = self._mainwin.ui.spinBox_9
            self.spinboxY = self._mainwin.ui.spinBox_10
            self.spinboxSize = self._mainwin.ui.spinBox_8
    ...
    def add_to_table(self, roi, colr):
        self.addlock = True
        ...
        if True:  # 선택 안되어있으면. :
            ...
            # colr = self.randcolr()
            self.add_table_form(new_row_num - 1, colr, roi)
        else:
    ...
    def add_table_form(self, num, colr, roi):
